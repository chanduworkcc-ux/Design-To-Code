...
const styles = StyleSheet.create({
  ...
  liveText: { fontSize: 10, fontFamily: "Inter_700Bold", color: "#059669" },
  ...
  codeLabel: { color: "rgba(255,255,255,0.7)", fontSize: 11, fontFamily: "Inter_500Medium" },
  codeValue: { color: "#fff", fontSize: 28, fontFamily: "Inter_700Bold", letterSpacing: 2, marginTop: 4 },
  codeHint: { color: "rgba(255,255,255,0.7)", fontSize: 11, fontFamily: "Inter_400Regular", marginTop: 4 },
  ...
  sectionTitle: { fontSize: 11, fontFamily: "Inter_600SemiBold", letterSpacing: 1, marginBottom: 10, marginLeft: 2 },
  ...
  memberJoined: { fontSize: 11, fontFamily: "Inter_400Regular", marginTop: 2 },
  coinsBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  coinsText: { fontSize: 12, fontFamily: "Inter_700Bold", color: "#059669" },
  orderCountText: { fontSize: 11, fontFamily: "Inter_400Regular" },

  latestOrderRow: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 14, paddingVertical: 10, borderTopWidth: 1 },
  latestOrderLabel: { fontSize: 12, fontFamily: "Inter_400Regular", flex: 1 },
  latestOrderAmt: { fontSize: 13, fontFamily: "Inter_700Bold" },
  ...
  memberRevLabel: { fontSize: 11, fontFamily: "Inter_400Regular", flex: 1, lineHeight: 16 },
  memberRevAmount: { fontSize: 16, fontFamily: "Inter_700Bold", marginLeft: 8 },
  noOrdersText: { fontSize: 13, fontFamily: "Inter_400Regular", textAlign: "center", paddingVertical: 12 },
  ...
  orderAmt: { fontSize: 14, fontFamily: "Inter_700Bold" },
  ...
  disclaimerTitle: { fontSize: 13, fontFamily: "Inter_700Bold", color: "#92400E" },
  disclaimerText: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#92400E", lineHeight: 18 },
});

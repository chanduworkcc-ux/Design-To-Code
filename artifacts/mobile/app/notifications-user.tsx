...
const styles = StyleSheet.create({
  ...
  emptyBody: { fontSize: 13, fontFamily: "DMSans_400Regular", textAlign: "center", lineHeight: 20 },
  ...
  notifTitle: { fontSize: 14, fontFamily: "DMSans_600SemiBold" },
  notifBody: { fontSize: 13, fontFamily: "DMSans_400Regular", lineHeight: 18 },
  notifTime: { fontSize: 11, fontFamily: "DMSans_400Regular" },
  forYouBadge: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 20, flexShrink: 0 },
  forYouText: { fontSize: 10, fontFamily: "DMSans_700Bold", color: "#fff" },
});

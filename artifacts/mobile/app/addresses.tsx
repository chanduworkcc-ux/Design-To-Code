...
const styles = StyleSheet.create({
  ...
  emptySubtitle: { fontSize: 13, fontFamily: "DMSans_400Regular" },
  ...
  labelText: { fontSize: 12, fontFamily: "DMSans_600SemiBold" },
  defaultText: { fontSize: 10, fontFamily: "DMSans_500Medium", color: "rgba(255,255,255,0.8)", marginLeft: 2 },
  cardActions: { flexDirection: "row", gap: 4 },
  iconBtn: { width: 32, height: 32, alignItems: "center", justifyContent: "center" },
  name: { fontSize: 15, fontFamily: "DMSans_600SemiBold" },
  phone: { fontSize: 13, fontFamily: "DMSans_400Regular" },
  addressLine: { fontSize: 13, fontFamily: "DMSans_400Regular", lineHeight: 20 },
  setDefaultBtn: { alignSelf: "flex-start", borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6, marginTop: 6 },
  setDefaultText: { fontSize: 12, fontFamily: "DMSans_600SemiBold" },
  ...
  fieldLabel: { fontSize: 11, fontFamily: "DMSans_600SemiBold", letterSpacing: 0.5, marginBottom: 6 },
  chip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, borderWidth: 1 },
  chipText: { fontSize: 13, fontFamily: "DMSans_600SemiBold" },
  input: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 11, fontSize: 14, fontFamily: "DMSans_400Regular" },
  defaultRow: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 20 },
  checkbox: { width: 20, height: 20, borderRadius: 5, borderWidth: 1.5, alignItems: "center", justifyContent: "center" },
  defaultLabel: { fontSize: 14, fontFamily: "DMSans_500Medium" },

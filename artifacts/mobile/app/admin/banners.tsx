...
const styles = StyleSheet.create({
  ...
  emptyText: { color: "#374151", fontSize: 16, fontFamily: "Inter_600SemiBold" },
  ...
  prevTitle: { fontSize: 16, fontFamily: "Inter_700Bold", marginBottom: 4 },
  prevSub: { fontSize: 12, fontFamily: "Inter_400Regular", marginBottom: 8 },
  prevCta: { alignSelf: "flex-start", paddingHorizontal: 10, paddingVertical: 5, borderWidth: 1, borderRadius: 20 },
  prevCtaText: { fontSize: 11, fontFamily: "Inter_600SemiBold" },
  ...
  sortText: { fontSize: 11, fontFamily: "Inter_700Bold" },
  ...
  inactiveText: { fontSize: 11, fontFamily: "Inter_600SemiBold", color: "#fff" },

...
const thread = StyleSheet.create({
  ...
  statusLabel: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: "#374151" },
  ...
  bubbleLabel: { fontSize: 10, fontFamily: "Inter_500Medium", color: "#9CA3AF" },
  bubbleText: { fontSize: 13, fontFamily: "Inter_400Regular", color: "#1F2937", lineHeight: 18 },
  replyRow: { flexDirection: "row", alignItems: "flex-end", gap: 8, padding: 10, borderTopWidth: 1, borderTopColor: "#F3F4F6" },
  replyInput: { flex: 1, backgroundColor: "#F3F4F6", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13, fontFamily: "Inter_400Regular", color: "#0F1740", maxHeight: 80 },
  ...
  closedText: { fontSize: 12, fontFamily: "Inter_500Medium", color: "#6B7280" },
});
...
const styles = StyleSheet.create({
  ...
  ticketNum: { fontSize: 12, fontFamily: "Inter_500Medium", color: "#2563EB" },

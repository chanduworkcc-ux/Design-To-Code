              ...
              <View style={styles.fieldGroup}>
                ...
                {(form.targetType === "new_users" || form.targetType === "old_users") && (
                  <View style={{ backgroundColor: "#FFFBEB", borderRadius: 8, padding: 10, marginTop: 4, borderWidth: 1, borderColor: "#FDE68A" }}>
                    <Text style={{ fontSize: 12, fontFamily: "DMSans_400Regular", color: "#92400E" }}>
...
const styles = StyleSheet.create({
  ...
  composeBtnText: { fontSize: 13, fontFamily: "DMSans_600SemiBold", color: "#fff" },
  content: { padding: 16, gap: 16 },
  composeCard: { backgroundColor: "#fff", borderRadius: 16, borderWidth: 1, borderColor: "#E5EAF8", padding: 18, gap: 14 },
  composeTitle: { fontSize: 16, fontFamily: "DMSans_700Bold", color: "#0F1740" },
  fieldGroup: { gap: 6 },
  ...
  segText: { fontSize: 13, fontFamily: "DMSans_600SemiBold", color: "#374151" },
  ...
  previewLabel: { fontSize: 11, fontFamily: "DMSans_600SemiBold", color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 0.8 },
  ...
  previewTitle: { fontSize: 14, fontFamily: "DMSans_700Bold", color: "#0F1740" },
  previewBody: { fontSize: 12, fontFamily: "DMSans_400Regular", color: "#6B7280", marginTop: 2 },
  ...
  sendBtnText: { color: "#fff", fontSize: 15, fontFamily: "DMSans_600SemiBold" },
  historyHeader: { flexDirection: "row", alignItems: "center", gap: 6 },
  historyTitle: { fontSize: 13, fontFamily: "DMSans_600SemiBold", color: "#6B7280" },
  ...
  emptyText: { color: "#374151", fontSize: 15, fontFamily: "DMSans_600SemiBold", textAlign: "center" },
  ...
  notifTitle: { flex: 1, fontSize: 14, fontFamily: "DMSans_700Bold", color: "#0F1740" },
  targetBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  targetText: { fontSize: 11, fontFamily: "DMSans_600SemiBold" },
  notifBody: { fontSize: 13, fontFamily: "DMSans_400Regular", color: "#374151" },
  notifDate: { fontSize: 11, fontFamily: "DMSans_400Regular", color: "#9CA3AF", marginTop: 6 },
});

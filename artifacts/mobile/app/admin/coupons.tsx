...
const styles = StyleSheet.create({
  ...
  codeText: { fontSize: 15, fontFamily: "DMSans_700Bold" },
  ...
  badgeText: { fontSize: 11, fontFamily: "DMSans_600SemiBold", color: "#6B7280" },
  couponMeta: { fontSize: 12, fontFamily: "DMSans_400Regular", color: "#6B7280", marginTop: 2 },

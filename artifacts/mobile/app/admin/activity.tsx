...
const styles = StyleSheet.create({
  ...
  summaryLabel: { fontSize: 10, fontFamily: "Inter_500Medium", color: "#9CA3AF" },
  ...
  logUser: { fontSize: 11, fontFamily: "Inter_400Regular", color: "#9CA3AF", maxWidth: 120 },
  logIp: { fontSize: 11, fontFamily: "Inter_400Regular", color: "#9CA3AF" },
  logTime: { fontSize: 11, fontFamily: "Inter_500Medium", color: "#6B7280", minWidth: 50, textAlign: "right" },
});

...
const styles = StyleSheet.create({
  ...
  productName: { fontSize: 14, fontFamily: "Inter_700Bold", color: "#0F1740", flex: 1 },
  activeBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  activeText: { fontSize: 11, fontFamily: "Inter_600SemiBold" },
  productCategory: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#6B7280", marginTop: 3 },
  priceRow: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 4 },
  priceText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#2563EB" },
  originalPrice: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#9CA3AF", textDecorationLine: "line-through" },
  discBadge: { backgroundColor: "#FEF2F2", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  discText: { fontSize: 11, fontFamily: "Inter_600SemiBold", color: "#EF4444" },
  ratingRow: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 3 },
  ratingText: { fontSize: 12, fontFamily: "Inter_500Medium", color: "#6B7280" },
  ...
  catChipText: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: "#374151" },

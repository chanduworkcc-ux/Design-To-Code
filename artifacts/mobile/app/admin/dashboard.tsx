          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                <Text style={[styles.navLabel, { color: active ? "#2563EB" : "#374151", fontFamily: active ? "DMSans_600SemiBold" : "DMSans_500Medium" }]}>
                  {item.label}
                </Text>
                {hasBadge && (
...
const styles = StyleSheet.create({
  ...
  pageHeader: { gap: 4 },
  pageTitle: { fontSize: 26, fontFamily: "DMSans_700Bold", color: "#0F1740" },
  pageSubtitle: { fontSize: 13, fontFamily: "DMSans_400Regular", color: "#6B7280" },
  ...
  quickLabel: { fontSize: 11, fontFamily: "DMSans_600SemiBold" },
  ...
  statLabel: { fontSize: 12, fontFamily: "DMSans_600SemiBold", flex: 1 },
  statIcon: { width: 34, height: 34, borderRadius: 10, alignItems: "center", justifyContent: "center" },
  statBottom: { flexDirection: "row", alignItems: "center", gap: 6 },
  statValue: { fontSize: 30, fontFamily: "DMSans_700Bold" },
  ...
  liveText: { fontSize: 12, fontFamily: "DMSans_500Medium", color: "#10B981" },
  sections: { gap: 12 },
  section: { borderRadius: 14, borderWidth: 1, padding: 16, gap: 10 },
  sectionHeaderRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  sectionTitle: { fontSize: 15, fontFamily: "DMSans_700Bold", color: "#0F1740" },
  sectionLink: { fontSize: 13, fontFamily: "DMSans_600SemiBold", color: "#2563EB" },
  noDataText: { fontSize: 13, fontFamily: "DMSans_400Regular", color: "#9CA3AF", paddingTop: 4 },
  orderRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderWidth: 1, borderRadius: 10, padding: 10 },
  orderIdText: { fontSize: 13, fontFamily: "DMSans_600SemiBold", color: "#0F1740" },
  orderStatus: { fontSize: 11, fontFamily: "DMSans_500Medium", marginTop: 2 },
  orderTotal: { fontSize: 14, fontFamily: "DMSans_700Bold", color: "#2563EB" },
  alertCard: { flexDirection: "row", alignItems: "center", gap: 12, borderRadius: 14, borderWidth: 1, padding: 16 },
  alertTitle: { fontSize: 14, fontFamily: "DMSans_700Bold" },
  alertSub: { fontSize: 12, fontFamily: "DMSans_400Regular", marginTop: 2 },
  ...
  quickNavLabel: { fontSize: 11, fontFamily: "DMSans_600SemiBold", textAlign: "center" },
  ...
  navBadgeText: { color: "#fff", fontSize: 11, fontFamily: "DMSans_700Bold" },
  soonTag: { fontSize: 9, fontFamily: "DMSans_700Bold", color: "#9CA3AF", backgroundColor: "#F3F4F6", paddingHorizontal: 5, paddingVertical: 2, borderRadius: 4 },
  ...
  drawerSignOutText: { fontSize: 14, fontFamily: "DMSans_600SemiBold", color: "#EF4444" },
  ...
  finLabel: { fontSize: 12, fontFamily: "DMSans_500Medium", color: "#6B7280" },
  finValue: { fontSize: 14, fontFamily: "DMSans_700Bold", color: "#0F1740", marginTop: 1 },
  ...
  storeToggleBtnText: { color: "#fff", fontSize: 13, fontFamily: "DMSans_700Bold" },
});

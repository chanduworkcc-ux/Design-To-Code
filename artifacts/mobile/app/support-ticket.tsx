...
const chat = StyleSheet.create({
  ...
  bubbleLabel: { fontSize: 10, fontFamily: "Inter_500Medium" },
  bubbleText: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 18 },
  bubbleImage: { width: 180, height: 120, borderRadius: 8, marginTop: 4 },
  emptyNotes: { fontSize: 13, fontFamily: "Inter_400Regular", textAlign: "center", paddingVertical: 20 },
  replyBar: { flexDirection: "row", alignItems: "flex-end", gap: 8, padding: 10, borderTopWidth: 1 },
  replyInput: { flex: 1, borderRadius: 12, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13, fontFamily: "Inter_400Regular", maxHeight: 80 },
  ...
  closedText: { fontSize: 12, fontFamily: "Inter_400Regular", flex: 1 },
});
...
const styles = StyleSheet.create({
  ...
  ticketDesc: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 20, marginBottom: 6 },
  ticketMeta: { flexDirection: "row", alignItems: "center", gap: 4 },
  ticketId: { fontSize: 11, fontFamily: "Inter_600SemiBold", marginRight: 6 },

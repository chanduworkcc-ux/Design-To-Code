...
const styles = StyleSheet.create({
  ...
  intro: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 20, marginBottom: 4 },
  ...
  policyItem: { gap: 4 },
  policyHeading: { fontSize: 13, fontFamily: "Inter_700Bold" },
  policyBody: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 20 },
  ...
  lastUpdated: { fontSize: 11, fontFamily: "Inter_400Regular", textAlign: "center", marginTop: 8 },
});

...
const styles = StyleSheet.create({
  ...
  emptyBody: { fontSize: 13, fontFamily: "Inter_400Regular", textAlign: "center", maxWidth: 240, lineHeight: 20 },
  ...
  productName: { fontSize: 14, fontFamily: "Inter_500Medium", lineHeight: 20 },
  ...
  cancelBadgeText: { color: "#EF4444", fontSize: 11, fontFamily: "Inter_600SemiBold" },
  divider: { height: 1 },
  detailsRow: { flexDirection: "row", gap: 16 },
  detailItem: { gap: 2 },
  detailLabel: { fontSize: 10, fontFamily: "Inter_500Medium", letterSpacing: 0.5 },
  ...
  reasonText: { flex: 1, fontSize: 12, fontFamily: "Inter_400Regular", color: "#991B1B", lineHeight: 16 },
